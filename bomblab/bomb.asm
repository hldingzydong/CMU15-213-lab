...
_start:
  ...
  400cb4:	e8 b7 fe ff ff 	callq	-329 <.plt+0xa0>
  400cb9:	f4 	hlt
  400cba:	90 	nop
  400cbb:	90 	nop
...
main:
  ...
  400dc7:	e8 44 fe ff ff 	callq	-444 <.plt+0x140>
  ...
  400de9:	e8 12 fe ff ff 	callq	-494 <.plt+0x130>
  400dee:	bf 08 00 00 00 	movl	$8, %edi
  400df3:	e8 28 fe ff ff 	callq	-472 <.plt+0x150>
  ...
  400e0a:	e8 f1 fd ff ff 	callq	-527 <.plt+0x130>
  400e0f:	bf 08 00 00 00 	movl	$8, %edi
  400e14:	e8 07 fe ff ff 	callq	-505 <.plt+0x150>
  400e19:	e8 84 05 00 00 	callq	1412 <initialize_bomb>
  400e1e:	bf 38 23 40 00 	movl	$4203320, %edi
  400e23:	e8 e8 fc ff ff 	callq	-792 <.plt+0x40>
  400e28:	bf 78 23 40 00 	movl	$4203384, %edi
  400e2d:	e8 de fc ff ff 	callq	-802 <.plt+0x40>
  ...
  400e49:	e8 c2 fc ff ff 	callq	-830 <.plt+0x40>
  ...
  400e65:	e8 a6 fc ff ff 	callq	-858 <.plt+0x40>
  ...
  400e81:	e8 8a fc ff ff 	callq	-886 <.plt+0x40>
  ...
  400e9d:	e8 6e fc ff ff 	callq	-914 <.plt+0x40>
  ...
  400eb9:	e8 52 fc ff ff 	callq	-942 <.plt+0x40>
...
phase_1:
  ...
  400ee9:	e8 4a 04 00 00 	callq	1098 <strings_not_equal>  //第二个参数为$4203520
  400eee:	85 c0 	        testl	%eax, %eax            // 判断是否相等
  400ef0:	74 05 	        je	5 <phase_1+0x17>        // 相等(返回为0)就return,代表成功,  0x400ef7
...
secret_phase:
  ...
  401255:	e8 76 f9 ff ff 	callq	-1674 <.plt+0x100>
  ...
  401287:	e8 84 f8 ff ff 	callq	-1916 <.plt+0x40>
...
sig_handler:
  ...
  4012a9:	e8 62 f8 ff ff 	callq	-1950 <.plt+0x40>
  4012ae:	bf 03 00 00 00 	movl	$3, %edi
  4012b3:	e8 98 f9 ff ff 	callq	-1640 <.plt+0x180>
  4012b8:	be 82 25 40 00 	movl	$4203906, %esi
  4012bd:	bf 01 00 00 00 	movl	$1, %edi
  4012c2:	b8 00 00 00 00 	movl	$0, %eax
  4012c7:	e8 34 f9 ff ff 	callq	-1740 <.plt+0x130>
  4012cc:	48 8b 3d 6d 24 20 00 	movq	2106477(%rip), %rdi
  4012d3:	e8 08 f9 ff ff 	callq	-1784 <.plt+0x110>
  4012d8:	bf 01 00 00 00 	movl	$1, %edi
  4012dd:	e8 6e f9 ff ff 	callq	-1682 <.plt+0x180>
  4012e2:	bf 8a 25 40 00 	movl	$4203914, %edi
  4012e7:	e8 24 f8 ff ff 	callq	-2012 <.plt+0x40>
  4012ec:	bf 10 00 00 00 	movl	$16, %edi
  4012f1:	e8 2a f9 ff ff 	callq	-1750 <.plt+0x150>
...
invalid_phase:
  ...
  40130c:	e8 ef f8 ff ff 	callq	-1809 <.plt+0x130>
  401311:	bf 08 00 00 00 	movl	$8, %edi
  401316:	e8 05 f9 ff ff 	callq	-1787 <.plt+0x150>
...
string_length:
  ...
  401332:	b8 00 00 00 00movl	$0, %eax
  401337:	c3 	          retq
...
strings_not_equal:
  ...
  401357:	41 39 c4 	     cmpl	%eax, %r12d   //比较52和输入的字符串的长度，不相等就return 1,因此输入的字符串的长度必须是52
  40135a:	75 3f 	       jne	63 <strings_not_equal+0x63>   // 0x40139b
  40135c:	0f b6 03 	     movzbl	(%rbx), %eax  //将输入的字符串的前四个字符放入$eax
  40135f:	84 c0 	       testb	%al, %al       // 因为char占一个字节,现在$eax保存前四个字符,因此$al保存首字符，所以首字符是0就可
  401361:	74 25 	       je	37 <strings_not_equal+0x50>     // 0x401388
  401363:	3a 45 00 	     cmpb	(%rbp), %al     //需要debug 查看(%rbp)
  401366:	74 0a 	       je	10 <strings_not_equal+0x3a>     // 0x401372 
  401368:	eb 25 	       jmp	37 <strings_not_equal+0x57>   // 0x40138f //return 1
  40136a:	3a 45 00 	     cmpb	(%rbp), %al
  40136d:	0f 1f 00 	     nopl	(%rax)
  401370:	75 24 	       jne	36 <strings_not_equal+0x5e>   // 0x401396
  401372:	48 83 c3 01 	 addq	$1, %rbx
  401376:	48 83 c5 01 	 addq	$1, %rbp
  40137a:	0f b6 03 	     movzbl	(%rbx), %eax
  40137d:	84 c0 	       testb	%al, %al
  40137f:	75 e9 	       jne	-23 <strings_not_equal+0x32>  // 0x40136a
  401381:	ba 00 00 00 00 movl	$0, %edx
  401386:	eb 13 	       jmp	19 <strings_not_equal+0x63>   // 0x40139b
  401388:	ba 00 00 00 00 movl	$0, %edx
  40138d:	eb 0c 	       jmp	12 <strings_not_equal+0x63>   // 0x40139b
  40138f:	ba 01 00 00 00 movl	$1, %edx
  401394:	eb 05 	       jmp	5 <strings_not_equal+0x63>    // 0x40139b
...
initialize_bomb:
  ...
  4013b0:	e8 db f7 ff ff 	callq	-2085 <.plt+0xc0>
...
blank_line:
  ...
  4013c7:	e8 94 f8 ff ff 	callq	-1900 <.plt+0x190>
...
skip:
  ...
  40141c:	e8 5f f7 ff ff 	callq	-2209 <.plt+0xb0>
...
explode_bomb:
  ...
  401443:	e8 c8 f6 ff ff 	callq	-2360 <.plt+0x40>
  401448:	bf ac 25 40 00 	movl	$4203948, %edi
  40144d:	e8 be f6 ff ff 	callq	-2370 <.plt+0x40>
...
read_line:
  ...
  4014c6:	e8 45 f6 ff ff 	callq	-2491 <.plt+0x40>
  4014cb:	bf 08 00 00 00 	movl	$8, %edi
  4014d0:	e8 4b f7 ff ff 	callq	-2229 <.plt+0x150>
  4014d5:	bf f3 25 40 00 	movl	$4204019, %edi
  4014da:	e8 01 f6 ff ff 	callq	-2559 <.plt+0x10>
  4014df:	48 85 c0 	testq	%rax, %rax
  4014e2:	74 0a 	je	10 <read_line+0x50>
  4014e4:	bf 00 00 00 00 	movl	$0, %edi
  4014e9:	e8 32 f7 ff ff 	callq	-2254 <.plt+0x150>
  ...
  401510:	e8 fb f5 ff ff 	callq	-2565 <.plt+0x40>
  401515:	bf 00 00 00 00 	movl	$0, %edi
  40151a:	e8 01 f7 ff ff 	callq	-2303 <.plt+0x150>
  ...
  401559:	e8 b2 f5 ff ff 	callq	-2638 <.plt+0x40>
...
phase_defused:
  ...
  4015fa:	e8 f1 f5 ff ff 	callq	-2575 <.plt+0x120>
  ...
  40164f:	e8 dc f4 ff ff 	callq	-2852 <.plt+0x60>
...
sigalrm_handler:
  ...
  40167f:	e8 bc f5 ff ff 	callq	-2628 <.plt+0x170>
  401684:	bf 01 00 00 00 	movl	$1, %edi
  401689:	e8 92 f5 ff ff 	callq	-2670 <.plt+0x150>
...
rio_readlineb:
  ...
  40171f:	e8 9c f4 ff ff 	callq	-2916 <.plt+0xf0>
...
submitr:
  ...
  401805:	e8 76 f4 ff ff 	callq	-2954 <.plt+0x1b0>
  ...
  401864:	e8 37 f3 ff ff 	callq	-3273 <.plt+0xd0>
  ...
  4018ca:	e8 81 f2 ff ff 	callq	-3455 <.plt+0x80>
  ...
  401907:	e8 a4 f2 ff ff 	callq	-3420 <.plt+0xe0>
  ...
  401924:	e8 07 f3 ff ff 	callq	-3321 <.plt+0x160>
  ...
  40197b:	e8 d0 f1 ff ff 	callq	-3632 <.plt+0x80>
  ...
  401a45:	e8 06 f1 ff ff 	callq	-3834 <.plt+0x80>
  ...
  401b0b:	e8 60 f1 ff ff 	callq	-3744 <.plt+0x1a0>
  ...
  401b53:	e8 c8 ef ff ff 	callq	-4152 <.plt+0x50>
  401b58:	48 85 c0 	testq	%rax, %rax
  401b5b:	7f 0f 	jg	15 <submitr+0x3c0>
  401b5d:	e8 8e ef ff ff 	callq	-4210 <.plt+0x20>
  ...
  401bc9:	e8 82 ef ff ff 	callq	-4222 <.plt+0x80>
  ...
  401c7c:	e8 cf ee ff ff 	callq	-4401 <.plt+0x80>
  ...
  401caf:	e8 3c ef ff ff 	callq	-4292 <.plt+0x120>
  ...
  401ce7:	e8 84 ef ff ff 	callq	-4220 <.plt+0x1a0>
  401cec:	44 89 e7 	movl	%r12d, %edi
  401cef:	e8 5c ee ff ff 	callq	-4516 <.plt+0x80>
  ...
  401d75:	e8 d6 ed ff ff 	callq	-4650 <.plt+0x80>
  ...
  401e25:	e8 26 ed ff ff 	callq	-4826 <.plt+0x80>
  ...
  401e39:	e8 c2 ec ff ff 	callq	-4926 <.plt+0x30>
  401e3e:	44 89 e7 	movl	%r12d, %edi
  401e41:	e8 0a ed ff ff 	callq	-4854 <.plt+0x80>
  ...
  401eb8:	e8 b3 ed ff ff 	callq	-4685 <.plt+0x1a0>
...
init_driver:
  ...
  40206c:	e8 2f eb ff ff 	callq	-5329 <.plt+0xd0>
  ...
  4020cf:	e8 7c ea ff ff 	callq	-5508 <.plt+0x80>
  ...
  40210a:	e8 a1 ea ff ff 	callq	-5471 <.plt+0xe0>
  ...
  402120:	e8 0b eb ff ff 	callq	-5365 <.plt+0x160>
  ...
  402181:	e8 aa e9 ff ff 	callq	-5718 <.plt+0x60>
...
driver_post:
  ...
  4021ab:	e8 50 ea ff ff 	callq	-5552 <.plt+0x130>
